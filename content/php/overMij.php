...
<div class="container">
    <div class="row">
        <div class="col-md-6">
            <p>
               Ik zit nu op scalda vlissingen hierbij krijg ik op dit moment les in databases, programmeren, software engineering ontwerpen en projectmatig werken (SCRUM). Verder krijg ik ook de Algemeen Vormende vakken; Nederlands, Rekenen/Wiskunde, Engels en Burgerschap Vitale Dimensie (Gym). Verder krijg ik ook nog loopbaansturing.
            </p>
        </div>
        <div class="col-md-6">
...
<h1 class="center ruimte">mijn bijbaan</h1>
    <div class="inhoud">
        <div>
            <div>
                <div style="display: inline-block; height: 329px; width: 329px;">
                    <img src="content/img/jumbo.jpg" height="327" width="327">
                </div>
                <div style="display: inline-block; width: 70%;">
                    <h1 class="margin_tekst">Jumbo Foodcorner goes</h1>
                    <p class="margin_tekst">Ik vul de slagerij schappen en ik zorg ervoor dat de winkel er verzorgd
                        en
                        uitnodigend uitziet voor
                        klanten.
                        ik help klanten bij het vinden van producten en als iets niet voorhanden is dan bied ik klanten een alternatief.
                        ik doet dit samen in een team.
                    </p>
                </div>
            </div>
        </div>
